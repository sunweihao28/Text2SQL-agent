...
### 1. 侧边栏聊天记录 & 主界面展示
![聊天记录与查询展示](Text2sql/assets/1-chat-history.png)
**功能：查询历史管理**
- 侧边栏按时间倒序显示历史查询列表
...
### 2. 智能体多模态响应
![多模态响应](Text2sql/assets/2-multi-modal-response.png)
智能体根据用户问题同时展示文字说明、SQL代码和查询结果数据，提供全方位洞察。

---

### 3. 数据库连接配置
![数据库连接](Text2sql/assets/3-database-connection.png)
**功能：数据库连接配置**
...
### 4. 长期记忆 (RAG)
![长期记忆](Text2sql/assets/4-long-term-memory.png)
**功能：RAG 记忆系统**
...
### 5. 智能数据可视化
![数据可视化](Text2sql/assets/5-data-visualization.png)
**功能：自动渲染图表**
